...
const OrderDelivery = ({route, navigation}) => {
    ...
    function calculateAngle(coordinates){
        ...
        let dy = endLat - startLat;
        let dx = endLng - startLng;
        ...
        return(
            <View style={{
                ...
                <View style={{
                    ...
                    <Image source={icons.red_pin}
                    style={{width:30, height:30,marginRight:SIZES.padding}}/>
                    <View style={{flex:1}}><Text style={{...FONTS.body3}}>{streetName}</Text></View>
                                ...
                                <View style={{flex:1, paddingLeft: SIZES.padding}}>
                                    ...
                                    <View style={{flexDirection:'row',justifyContent:"space-between"}}>
                                        ...
                                        <View style={{flexDirection:'row'}}>
                                            <Image source={icons.star} style={{width:18,height:18,tintColor:COLORS.primary,marginRight:SIZES.padding}}/>
